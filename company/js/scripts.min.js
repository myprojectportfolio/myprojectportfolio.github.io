...
$(function(){$(".slide-wrap").slideDown(),$(".popup-with-zoom-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom"}),$("a[href=\\#callback]").click(function(){$("#callback .formname").val($(this).data("form"))}),$(".service-item h4").equalHeights(),$(".new-item-text").equalHeights(),$(".top-line .sf-menu").superfish({cssArrows:!1,hoverClass:"no-class",delay:200}),$(".partners").owlCarousel({loop:!0,smartSpeed:700,dots:!0,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},480:{items:2},992:{items:4}}});var e=$(".owl-carousel");e.owlCarousel({itemClass:"slide-wrap",navText:"",loop:!0,margin:0,nav:!0,dots:!0,autoplay:!1,smartSpeed:1500,autoplayTimeout:3e3,responsive:{0:{items:1},600:{items:1},1000:{items:1}}}),$(".next").on("click",function(){e.trigger("next.owl.carousel",[500])}),$(".prev").on("click",function(){e.trigger("prev.owl.carousel",[500])}),$(".sf-menu").after("<div id='my-menu'>"),$(".sf-menu").clone().appendTo("#my-menu"),$("#my-menu").find("*").attr("style",""),$("#my-menu").find("ul").removeClass("sf-menu"),$("#my-menu").mmenu({extensions:["effect-menu-slide","pagedim-black","border-full"],navbar:{title:"Меню"}});$("#my-menu").data("mmenu");$(".mobile-mnu").click(function(){return $("#my-menu").data("mmenu").open(),$(this).find(".toggle-mnu").toggleClass("on"),$(".main-mnu").slideToggle(),!1}),$("callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(".success").addClass("visible"),setTimeout(function(){e.trigger("reset"),$(".success").removeClass("visible"),$.magnificPopup.close()},3e3)}),!1}),Modernizr.svg||$("img[src*='svg']").attr("src",function(){return $(this).attr("src").replace(".svg",".png")})}),$(window).on("load",function(){$(".loader_inner").fadeOut(),$(".loader").delay(400).fadeOut("slow")});