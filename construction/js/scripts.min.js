...
$(function(){function a(){$(".item-vertical p").height("auto").equalHeights(),$(".testimonials-head").height("auto").equalHeights(),$(".testimonials-desc").height("auto").equalHeights()}$(".gallery-tizer-wrap").attr("href",$(".gallery-images a").attr("href")).css("background-image","url("+$(".gallery-images a").data("preview")+")"),$(".gallery-images a:first").remove(),$(".certificate-wrap > a").attr("href",$(".certificates a").attr("href")),$(".certificates a:first").remove(),$("form select").selectize(),$(".mouse-icon").click(function(){$("html, body").animate({scrollTop:$(".s-adv").offset().top},600)}),$(".s-adv").waypoint(function(){$({blurRadius:5}).animate({blurRadius:0},{duration:1200,easing:"swing",step:function(){$(".s-adv-item h3 span").css({"-webkit-filter":"blur("+this.blurRadius+"px)",filter:"blur("+this.blurRadius+"px)"})}});var a=$.animateNumber.numberStepFactories.separator(" ");$(".s-adv-item h3 span").each(function(){var e=$(this).data("count");$(this).animateNumber({number:e,easing:"easeInQuad","font-size":"34px",numberStep:a},1200)}),this.destroy()},{offset:"70%"}),$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(this).parent().next().next().find(".main-mnu").slideToggle(),!1}),$(".main-foot .toggle-mnu").click(function(){return $("html, body").animate({scrollTop:$(document).height()+200},"slow"),!1}),$(".mfp-gallery").each(function(){$(this).magnificPopup({delegate:"a",mainClass:"mfp-zoom-in",type:"image",tLoading:"",gallery:{enabled:!0},removalDelay:300,callbacks:{beforeChange:function(){this.items[0].src=this.items[0].src+"?="+Math.random()},open:function(){$.magnificPopup.instance.next=function(){var a=this;a.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.next.call(a)},120)},$.magnificPopup.instance.prev=function(){var a=this;a.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.prev.call(a)},120)}},imageLoadComplete:function(){var a=this;setTimeout(function(){a.wrap.addClass("mfp-image-loaded")},16)}}})}),$("form").submit(function(){var a=$(this);return $.ajax({type:"POST",url:"mail.php",data:a.serialize()}).done(function(){a.find(".success").addClass("active"),setTimeout(function(){a.find(".success").removeClass("active"),a.trigger("reset"),$.magnificPopup.close()},3e3)}),!1}),$(".portfolio-item").each(function(a){$(this).attr("href","#portfolio-img-"+a).find(".portfolio-popup").attr("id","portfolio-img-"+a)}),$(".portfolio-item, a[href='#callback']").magnificPopup({mainClass:"my-mfp-zoom-in",removalDelay:300,type:"inline"}),$("a[href='#callback']").click(function(){var a=$(this).data("form"),e=$(this).data("text");$(".form-callback h4").text(e),$(".form-callback [name=admin-data]").val(a)}),$(window).resize(function(){a()}),a(),$("body").append('<div class="top"><i class="fa fa-angle-double-up">'),$("img, a").on("dragstart",function(a){a.preventDefault()}),$("body").on("click",".top",function(){$("html, body").animate({scrollTop:0},"slow")}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});