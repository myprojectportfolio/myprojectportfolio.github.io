...
$(function(){function i(){$(".item-vertical p").height("auto").equalHeights(),$(".testimonials-head").height("auto").equalHeights(),$(".testimonials-desc").height("auto").equalHeights()}$(".mouse-icon").click(function(){$("html, body").animate({scrollTop:$(".s-adv").offset().top},600)}),$(".s-adv").waypoint(function(){$({blurRadius:5}).animate({blurRadius:0},{duration:1200,easing:"swing",step:function(){$(".s-adv-item h3 span").css({"-webkit-filter":"blur("+this.blurRadius+"px)",filter:"blur("+this.blurRadius+"px)"})}});var t=$.animateNumber.numberStepFactories.separator(" ");$(".s-adv-item h3 span").each(function(){var i=$(this).data("count");$(this).animateNumber({number:i,easing:"easeInQuad","font-size":"34px",numberStep:t},1200)}),this.destroy()},{offset:"70%"}),$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(".main-mnu").slideToggle(),!1}),$(".mfp-gallery").magnificPopup({type:"image",gallery:{enabled:!0}}),$(".mfp-sertificate").magnificPopup({type:"image",gallery:{enabled:!0}}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),$("form").submit(function(){var i=$(this);return $.ajax({type:"POST",url:"/mail.php",data:i.serialize()}).done(function(){i.find(".success").addClass("active"),setTimeout(function(){i.find(".success").removeClass("active"),i.trigger("reset"),$.magnificPopup.close()},3e3)}),!1}),$(".portfolio-item").each(function(i){$(this).attr("href","#portfolio-img-"+i).find(".portfolio-popup").attr("id","portfolio-img-"+i)}),$(".portfolio-item, a[href='#callback']").magnificPopup({mainClass:"my-mfp-zoom-in",removalDelay:50,type:"inline"}),$("a[href='#callback']").click(function(){var i=$(this).data("form"),t=$(this).data("text");$(".form-callback h4").text(t),$(".form-callback [name=admin-data]").val(i)}),$(window).resize(function(){i()}),i()});