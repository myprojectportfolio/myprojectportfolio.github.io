$(function() {
	...
	$('.main-head').parallax({imageSrc: 'img/services1.jpg'});
  $('.s-work').parallax({imageSrc: 'img/services2.jpg'});
...
$(window).scroll(function() {
if ($(this).scrollTop() > 1){  
    $('.header-content .logo_header').addClass("sticky");
  }
  else{
    $('.header-content .logo_header').removeClass("sticky");
  }
});
...
$(window).scroll(function() {
if ($(this).scrollTop() > 1){  
    $('.mnu-line2').addClass("sticky");
  }
  else{
    $('.mnu-line2').removeClass("sticky");
  }
});
